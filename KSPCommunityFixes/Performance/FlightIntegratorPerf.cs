...
namespace KSPCommunityFixes.Performance
{
    internal class FlightIntegratorPerf : BasePatch
    {
        ...
        static void UpdateOcclusionData(OcclusionData occlusionData, Vector3d velocity, QuaternionDPointRotation velToUp)
        {
            ...
            Vector3d boundVert1 = MultiplyPoint3x4(ref localToWorldMatrix, minX, minY, minZ);
            Vector3d boundVert2 = MultiplyPoint3x4(ref localToWorldMatrix, maxX, maxY, maxZ);
            Vector3d boundVert3 = MultiplyPoint3x4(ref localToWorldMatrix, minX, minY, maxZ);
            Vector3d boundVert4 = MultiplyPoint3x4(ref localToWorldMatrix, minX, maxY, minZ);
            Vector3d boundVert5 = MultiplyPoint3x4(ref localToWorldMatrix, maxX, minY, minZ);
            Vector3d boundVert6 = MultiplyPoint3x4(ref localToWorldMatrix, minX, maxY, maxZ);
            Vector3d boundVert7 = MultiplyPoint3x4(ref localToWorldMatrix, maxX, minY, maxZ);
            Vector3d boundVert8 = MultiplyPoint3x4(ref localToWorldMatrix, maxX, maxY, minZ);
            ...
            Vector3d worldBoundsCenter = MultiplyPoint3x4(ref localToWorldMatrix, cX, cY, cZ);
