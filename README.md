...
- **[RoboticsDrift](https://github.com/KSPModdingLibs/KSPCommunityFixes/issues/13)** [KSP 1.8.0 - 1.12.4]<br/>Prevent unrecoverable part position drift of Breaking Grounds DLC robotic parts and their children parts.
...
- TextureLoaderOptimizations : Added a fix for a KSP bug causing hangs when an invalid `*.png` file is being loaded (usually an autogenerated zero size part thumbnail), see https://github.com/KSPModdingLibs/KSPCommunityFixes/issues/69 (Thanks to @JonnyOThan). Also made a few improvements to PNG loading speed (always active even if you don't use the texture cache).
