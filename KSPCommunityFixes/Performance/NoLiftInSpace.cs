...
namespace KSPCommunityFixes.Performance
{
    class NoLiftInSpace : BasePatch
    {
        ...
        {
            AddPatch(PatchType.Prefix, typeof(ModuleLiftingSurface), nameof(ModuleLiftingSurface.FixedUpdate));
            AddPatch(PatchType.Prefix, typeof(ModuleControlSurface), nameof(ModuleControlSurface.FixedUpdate));
        }
